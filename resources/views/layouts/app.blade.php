...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse d-flex justify-content-between" id="navbarTogglerDemo03">
            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0 d-flex align-items-center">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="{{route('recharge', auth()->user()->id)}}">Recharge</a>
                </li>
                @endif

                <a href="{{route('settings')}}" class="nav-item nav-link active">
    ...
    <!-- JS -->
    <script src="https://kit.fontawesome.com/9c39fc0c8c.js" crossorigin="anonymous"></script>
</body>
